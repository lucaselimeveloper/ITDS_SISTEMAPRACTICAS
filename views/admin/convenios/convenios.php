        ...
        <section class="container mx-auto px-4 py-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-4">
                    <a href="registrar_convenio.php" class="bg-yellow-500 text-black font-bold px-4 py-2 rounded-lg hover:bg-yellow-600 transition duration-300">
    ...
    <div id="editModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
        ...
        if (!selectedRow) {
            alert('Por favor selecciona un convenio para editar');
            return;
        }
        
        const convenioId = selectedRow.getElementsByTagName('td')[0].textContent.trim();
        window.location.href = `editar_convenio.php?id=${convenioId}`;
    });
